...
class Regle(db.Model):
    ...
    run = db.relationship('RegleRun', backref='regle', lazy='dynamic')
    alt = db.relationship('RegleAlt', backref='regle', lazy='dynamic')
    texte = db.relationship('RegleTexte', backref='regle', lazy='dynamic')
    definition = db.relationship('RegleDef', backref='regle', lazy='dynamic')
    contexte = db.relationship('RegleContexte', backref='regle', lazy='dynamic')
    condition = db.relationship('RegleCondition', backref='regle', lazy='dynamic')
    action = db.relationship('RegleAction', backref='regle', lazy='dynamic')
    package = db.relationship('ReglePackage', backref='regle', lazy='dynamic')
